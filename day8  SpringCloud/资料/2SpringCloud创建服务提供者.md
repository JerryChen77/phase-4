    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.duo.hello.spring.cloud.service.admin.ServiceAdminApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```
package com.duo.hello.spring.cloud.service.admin;
...
```
package com.duo.hello.spring.cloud.service.admin.controller;
