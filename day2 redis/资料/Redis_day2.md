...
#密码
sentinel auth-pass mymaster qfjava
```
...
> Redis集群在保证主从加哨兵的基本功能之外，还能够提升	Redis存储数据的能力。
...
```sh
redis-cli --cluster create 192.168.140.129:7001 192.168.140.129:7002 192.168.140.129:7003 192.168.140.129:7004 192.168.140.129:7005 192.168.140.129:7006 --cluster-replicas 1
```
