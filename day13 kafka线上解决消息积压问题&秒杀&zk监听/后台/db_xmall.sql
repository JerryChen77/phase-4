/*
 ...
 Source Schema         : db_xmall

 Target Server Type    : MySQL
 Target Server Version : 80023
 File Encoding         : 65001

 Date: 13/04/2021 11:28:05
*/
...
CREATE TABLE `tb_base` (
  ...
  `has_log_notice` int DEFAULT NULL,
  `log_notice` varchar(1000) DEFAULT NULL,
  `has_all_notice` int DEFAULT NULL,
...
CREATE TABLE `tb_dict` (
  ...
  `type` int DEFAULT NULL COMMENT '1扩展词 0停用词',
  PRIMARY KEY (`id`)
...
CREATE TABLE `tb_item_cat` (
  ...
  `parent_id` bigint DEFAULT NULL COMMENT '父分类ID=0时代表一级根分类',
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_log` VALUES (10, '登录系统', 1, '/user/login', 'POST', '{\"password\":\"你是看不见我的\",\"t\":\"1617719597038\",\"challenge\":\"c74d97b01eae257e44aa9d5bade97baf45\",\"seccode\":\"582c3129eea2122308d59d98c314ddea|jordan\",\"username\":\"test\",\"validate\":\"582c3129eea2122308d59d98c314ddea\"}', 'test', '127.0.0.1', '未知', 11006, '2021-04-06 22:33:17');
INSERT INTO `tb_log` VALUES (11, '登录系统', 1, '/user/login', 'POST', '{\"password\":\"你是看不见我的\",\"t\":\"1618147767431\",\"challenge\":\"3ef815416f775098fe977004015c6193c5\",\"seccode\":\"5e1b7c5f2ea0ccac194e1e2f80018b50|jordan\",\"username\":\"test\",\"validate\":\"5e1b7c5f2ea0ccac194e1e2f80018b50\"}', 'test', '127.0.0.1', '未知', 7734, '2021-04-11 21:29:28');
INSERT INTO `tb_log` VALUES (12, '登录系统', 1, '/user/login', 'POST', '{\"password\":\"你是看不见我的\",\"t\":\"1618149113288\",\"challenge\":\"c20ad4d76fe97759aa27a0c99bff6710e2\",\"seccode\":\"fd3266973fd35c79e838684cffcf9ac8|jordan\",\"username\":\"test\",\"validate\":\"fd3266973fd35c79e838684cffcf9ac8\"}', 'test', '127.0.0.1', '未知', 7072, '2021-04-11 21:51:53');
INSERT INTO `tb_log` VALUES (13, '登录系统', 1, '/user/login', 'POST', '{\"password\":\"你是看不见我的\",\"t\":\"1618226400165\",\"challenge\":\"03afdbd66e7929b125f8597834fa83a432\",\"seccode\":\"64aa9fd184e66cbcb397a169ae2c1040|jordan\",\"username\":\"test\",\"validate\":\"64aa9fd184e66cbcb397a169ae2c1040\"}', 'test', '127.0.0.1', '未知', 40740, '2021-04-12 19:20:00');
INSERT INTO `tb_log` VALUES (14, '登录系统', 1, '/user/login', 'POST', '{\"password\":\"你是看不见我的\",\"t\":\"1618227642177\",\"challenge\":\"c7e1249ffc03eb9ded908c236bd1996ded\",\"seccode\":\"48028ce3a0b47075a285662b66f7f6fc|jordan\",\"username\":\"test\",\"validate\":\"48028ce3a0b47075a285662b66f7f6fc\"}', 'test', '127.0.0.1', '未知', 15467, '2021-04-12 19:40:42');
INSERT INTO `tb_log` VALUES (15, '登录系统', 1, '/user/login', 'POST', '{\"password\":\"你是看不见我的\",\"t\":\"1618274966484\",\"challenge\":\"f033ab37c30201f73f142449d037028d54\",\"seccode\":\"4e339c0430b57a623fc12bd0cac83139|jordan\",\"username\":\"test\",\"validate\":\"4e339c0430b57a623fc12bd0cac83139\"}', 'test', '127.0.0.1', '未知', 277, '2021-04-13 08:49:27');
INSERT INTO `tb_log` VALUES (16, '登录系统', 1, '/user/login', 'POST', '{\"password\":\"你是看不见我的\",\"t\":\"1618279993303\",\"challenge\":\"3295c76acbf4caaed33c36b1b5fc2cb186\",\"seccode\":\"44552cca8939e554d04215863b98278b|jordan\",\"username\":\"test\",\"validate\":\"44552cca8939e554d04215863b98278b\"}', 'test', '127.0.0.1', '未知', 1147, '2021-04-13 10:13:13');
INSERT INTO `tb_log` VALUES (17, '登录系统', 1, '/user/login', 'POST', '{\"password\":\"你是看不见我的\",\"t\":\"1618280400430\",\"challenge\":\"f457c545a9ded88f18ecee47145a72c097\",\"seccode\":\"ceb46296c2e7fdac68ad984b89a6f000|jordan\",\"username\":\"test\",\"validate\":\"ceb46296c2e7fdac68ad984b89a6f000\"}', 'test', '127.0.0.1', '未知', 22300, '2021-04-13 10:20:00');
INSERT INTO `tb_log` VALUES (18, '登录系统', 1, '/user/login', 'POST', '{\"password\":\"你是看不见我的\",\"t\":\"1618280651720\",\"challenge\":\"66f041e16a60928b05a7e228a89c379945\",\"seccode\":\"9506bea6267f4ac1ce752f2fdbae82ad|jordan\",\"username\":\"test\",\"validate\":\"9506bea6267f4ac1ce752f2fdbae82ad\"}', 'test', '127.0.0.1', '未知', 1011, '2021-04-13 10:24:12');
INSERT INTO `tb_log` VALUES (19, '登录系统', 1, '/user/login', 'POST', '{\"password\":\"你是看不见我的\",\"t\":\"1618280770618\",\"challenge\":\"6512bd43d9caa6e02c990b0a82652dca98\",\"seccode\":\"8203357386ab1442f28d3a48cf3fb564|jordan\",\"username\":\"test\",\"validate\":\"8203357386ab1442f28d3a48cf3fb564\"}', 'test', '127.0.0.1', '未知', 594, '2021-04-13 10:26:11');
COMMIT;
...
INSERT INTO `tb_order` VALUES ('161815206415869', 1.00, NULL, NULL, 1, '2021-04-11 22:41:04', '2021-04-12 19:14:11', '2021-04-12 19:14:11', NULL, NULL, NULL, NULL, NULL, 62, NULL, 'test', NULL);
INSERT INTO `tb_order` VALUES ('161822523664525', 1.00, NULL, NULL, 1, '2021-04-12 19:00:37', '2021-04-12 19:08:35', '2021-04-12 19:08:35', NULL, NULL, NULL, NULL, NULL, 62, NULL, 'test', NULL);
INSERT INTO `tb_order` VALUES ('161828099134996', 1.00, NULL, NULL, 1, '2021-04-13 10:29:51', '2021-04-13 10:30:01', '2021-04-13 10:30:01', NULL, NULL, NULL, NULL, NULL, 62, NULL, 'test', NULL);
INSERT INTO `tb_order` VALUES ('161828184158936', 49.00, NULL, NULL, 1, '2021-04-13 10:44:02', '2021-04-13 10:44:04', '2021-04-13 10:44:04', NULL, NULL, NULL, NULL, NULL, 62, NULL, 'test', NULL);
COMMIT;
...
INSERT INTO `tb_order_item` VALUES ('161815206416594', '150635087972564', '161815206415869', 1, '支付测试商品 IPhone X 全面屏 全面绽放', 1.00, 1.00, 'https://i.loli.net/2018/07/13/5b48ac7766d98.png');
INSERT INTO `tb_order_item` VALUES ('161822523666022', '150635087972564', '161822523664525', 1, '支付测试商品 IPhone X 全面屏 全面绽放', 1.00, 1.00, 'https://i.loli.net/2018/07/13/5b48ac7766d98.png');
INSERT INTO `tb_order_item` VALUES ('161828099135490', '150635087972564', '161828099134996', 1, '支付测试商品 IPhone X 全面屏 全面绽放', 1.00, 1.00, 'https://i.loli.net/2018/07/13/5b48ac7766d98.png');
INSERT INTO `tb_order_item` VALUES ('161828184159047', '150642571432837', '161828184158936', 1, '坚果 3 前屏钢化玻璃保护膜', 49.00, 49.00, 'https://resource.smartisan.com/resource/3a7522290397a9444d7355298248f197.jpg');
COMMIT;
...
INSERT INTO `tb_order_shipping` VALUES ('161815206415869', '1', '1', NULL, NULL, NULL, NULL, '1', NULL, '2021-04-11 22:41:04', '2021-04-11 22:41:04');
INSERT INTO `tb_order_shipping` VALUES ('161822523664525', '1', '1', NULL, NULL, NULL, NULL, '1', NULL, '2021-04-12 19:00:37', '2021-04-12 19:00:37');
INSERT INTO `tb_order_shipping` VALUES ('161828099134996', '1', '1', NULL, NULL, NULL, NULL, '1', NULL, '2021-04-13 10:29:51', '2021-04-13 10:29:51');
INSERT INTO `tb_order_shipping` VALUES ('161828184158936', '1', '1', NULL, NULL, NULL, NULL, '1', NULL, '2021-04-13 10:44:02', '2021-04-13 10:44:02');
COMMIT;
...
CREATE TABLE `tb_panel` (
  ...
  `type` int DEFAULT NULL COMMENT '类型 0轮播图 1板块种类一 2板块种类二 3板块种类三 ',
  `sort_order` int DEFAULT NULL COMMENT '排列序号',
  `position` int DEFAULT NULL COMMENT '所属位置 0首页 1商品推荐 2我要捐赠',
  `limit_num` int DEFAULT NULL COMMENT '板块限制商品数量',
...
CREATE TABLE `tb_panel_content` (
  ...
  `type` int DEFAULT NULL COMMENT '类型 0关联商品 1其他链接',
...
INSERT INTO `tb_panel_content` VALUES (25, 8, 0, 150642571432837, 1, 'https://www.smartisan.com/jianguo3-accessories', 'https://resource.smartisan.com/resource/6/610400xinpinpeijian.jpg', NULL, NULL, '2018-04-15 19:07:43', '2018-04-19 23:20:34');
...
INSERT INTO `tb_panel_content` VALUES (27, 8, 0, 150642571432837, 3, 'https://www.smartisan.com/category?id=69', 'https://resource.smartisan.com/resource/4/489673079577637073.png', NULL, NULL, '2018-04-15 19:08:24', '2018-04-19 23:21:01');
...
INSERT INTO `tb_panel_content` VALUES (32, 7, 0, 150635087972564, 1, '', 'https://ooo.0o0.ooo/2019/09/30/CAZ6QrXPBoh5aIT.png', 'https://ooo.0o0.ooo/2019/09/30/9Y5MHc8sfhJLk3u.png', 'https://ooo.0o0.ooo/2019/09/30/lLv8xp3IWqa7Oz6.png', '2018-04-17 20:41:02', '2018-04-17 20:58:41');
...
INSERT INTO `tb_panel_content` VALUES (37, 9, 0, 150642571432837, 2, 'https://www.smartisan.com/os/#/4-x', 'https://resource.smartisan.com/resource/6/610400dibu.jpg', NULL, NULL, '2018-04-18 23:51:51', '2018-04-20 12:03:19');
...
INSERT INTO `tb_panel_content` VALUES (39, 9, 0, 150642571432837, 4, 'https://www.smartisan.com/pr/#/video/onestep-introduction', 'https://resource.smartisan.com/resource/m/minibanner_03.jpg', NULL, NULL, '2018-04-18 23:52:02', '2018-04-20 12:03:41');
...
INSERT INTO `tb_panel_content` VALUES (48, 6, 0, 150642571432837, 2, NULL, 'http://ow2h3ee9w.bkt.clouddn.com/FgwHSk1Rnd-8FKqNJhFSSdcq2QVB', NULL, NULL, '2018-04-19 11:18:16', '2018-04-19 11:18:18');
...
INSERT INTO `tb_panel_content` VALUES (50, 4, 0, 150642571432837, 2, NULL, 'http://ow2h3ee9w.bkt.clouddn.com/FgwHSk1Rnd-8FKqNJhFSSdcq2QVB', NULL, NULL, '2018-04-19 11:20:19', '2018-04-19 11:20:21');
INSERT INTO `tb_panel_content` VALUES (55, 0, 1, NULL, 1, 'http://www.duo.com', '品牌周边', NULL, NULL, '2018-07-27 20:48:21', '2018-07-27 22:32:51');
INSERT INTO `tb_panel_content` VALUES (58, 0, 1, NULL, 2, 'http://localhost:8888', '后台管理系统', NULL, NULL, '2018-07-27 20:50:07', '2018-07-27 22:25:18');
COMMIT;
...
CREATE TABLE `tb_thanks` (
  ...
  `state` int DEFAULT '0' COMMENT '状态 0待审核 1确认显示  2驳回 3通过不展示',
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_thanks` VALUES (7, '', 'test', 1.00, '', '', 0, 'Alipay', '161822523664525', '2021-04-12 19:08:35');
INSERT INTO `tb_thanks` VALUES (8, '', 'test', 1.00, '', '', 0, 'Alipay', '161815206415869', '2021-04-12 19:11:13');
INSERT INTO `tb_thanks` VALUES (9, '', 'test', 1.00, '', '', 0, 'Wechat', '161815206415869', '2021-04-12 19:14:11');
INSERT INTO `tb_thanks` VALUES (10, '', 'test', 1.00, '', '', 0, 'Alipay', '161828099134996', '2021-04-13 10:30:01');
INSERT INTO `tb_thanks` VALUES (11, '', 'test', 1.00, '', '', 0, 'Alipay', '161828184158936', '2021-04-13 10:44:04');
COMMIT;
