...
* 两个域名是 admin.service.itoken.duo.com 和 admin.web.itoken.duo.com
* Nginx 服务器使用虚拟机 192.168.75.145

### 配置 Windows Hosts 文件

- 通过 host 文件指定 admin.service.itoken.duo.com 和 admin.web.itoken.duo.com 对应 192.168.75.145 虚拟机：
